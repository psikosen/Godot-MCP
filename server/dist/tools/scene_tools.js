...
var materialValueSchema = z.union([
    z.string(),
    z.number(),
    z.boolean(),
    z.array(z.any()),
...
var meshoptimizerSchema = z
    ...
    .catchall(z.any())
    .partial();
var configureMaterialResourceSchema = z
    .object({
    resource_path: z
        .string()
...
var formatMaterialResponse = function (result) {
    var _a, _b, _c;
    var resourcePath = (_a = result.resource_path) !== null && _a !== void 0 ? _a : 'res://unknown.tres';
    var materialType = (_b = result.material_type) !== null && _b !== void 0 ? _b : 'Material';
    var status = (_c = result.status) !== null && _c !== void 0 ? _c : 'pending';
    var created = Boolean(result.created_new);
    var changes = Array.isArray(result.changes) ? result.changes : [];
    if (changes.length === 0) {
        return "".concat(materialType, " at ").concat(resourcePath, " required no changes (").concat(status, ").");
    }
    var changeLines = changes.map(function (change) {
        ...
        var typedChange = change;
        var type = (_a = typedChange.type) !== null && _a !== void 0 ? _a : 'change';
        if (type === 'material_created') {
            var createdType = (_b = typedChange.material_type) !== null && _b !== void 0 ? _b : materialType;
            return "- Created material of type ".concat(createdType);
        }
        var identifier = (_e = (_d = (_c = typedChange.property) !== null && _c !== void 0 ? _c : typedChange.parameter) !== null && _d !== void 0 ? _d : typedChange.material_type) !== null && _e !== void 0 ? _e : type;
        var oldValue = formatVariant((_f = typedChange.old_value) !== null && _f !== void 0 ? _f : '∅');
        var newValue = formatVariant((_g = typedChange.new_value) !== null && _g !== void 0 ? _g : '');
        var resourceRef = (_h = typedChange.resource_path) !== null && _h !== void 0 ? _h : '';
        var resourceSuffix = resourceRef ? " (".concat(resourceRef, ")") : '';
        return "- ".concat(type, ": ").concat(identifier).concat(resourceSuffix, " \u2014 ").concat(oldValue, " -> ").concat(newValue);
    });
    var prefix = created ? 'Created' : 'Updated';
    return "".concat(prefix, " ").concat(materialType, " at ").concat(resourcePath, " [").concat(status, "]\n").concat(changeLines.join('\n'));
};
        ...
        execute: function (params) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, godot.sendCommand('configure_material_resource', params)];
                    case 2:
                        result = _a.sent();
